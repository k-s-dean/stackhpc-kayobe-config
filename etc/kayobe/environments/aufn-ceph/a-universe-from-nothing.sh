...
BASE_PATH=~
KAYOBE_BRANCH=ubuntu-repos  # FIXME
KAYOBE_CONFIG_BRANCH=rug/wallaby-aufn  # FIXME
...
# Deploy Pulp
./kayobe-config/etc/kayobe/environments/aufn-ceph/deploy-pulp.sh
...
# NOTE: Building containers locally for now.
...
source $KOLLA_CONFIG_PATH/public-openrc.sh
$KAYOBE_CONFIG_PATH/environments/aufn-ceph/init-runonce.sh
